...
async function startServer() {
  ...
  app.use((req, res, next) => {
    res.setHeader(
      ...
      "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://*.clerk.accounts.dev https://clerk.berroastudio.com https://ecommerce.berroastudio.com https://embed.tawk.to; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.stripe.com https://*.clerk.accounts.dev https://ecommerce.berroastudio.com https://clerk.berroastudio.com wss://clerk.berroastudio.com https://fonts.googleapis.com https://fonts.gstatic.com https://*.tawk.to wss://*.tawk.to; img-src 'self' data: blob: https://*.supabase.co https://*.stripe.com https://*.gstatic.com https://*.google.com https://raw.githubusercontent.com https://*.tawk.to; font-src 'self' data: https://fonts.gstatic.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; frame-src 'self' https://js.stripe.com https://embed.tawk.to; worker-src 'self' blob:;"
    );
    next();
  });
